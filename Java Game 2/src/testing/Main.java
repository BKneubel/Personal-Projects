...
public class Main {
	...
	public static int spinnerPrevValue = 0, spinner1PrevValue = 0, spinner2PrevValue = 0;
	public static int spinnerValue = 0, spinner1Value = 0, spinner2Value = 0;
		...
		*/
		...
		spinner1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				spinner1Value = (int) spinner1.getValue();
				points();
			}
		});
		...
		spinner2.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				spinner2Value = (int) spinner2.getValue();
				points();
			}
		});
	...
	public static void points(){
		...
		if(spinnerValue > spinnerPrevValue){
			if(hasPoints){
				points--;
				spinnerPrevValue = spinnerValue;
			}
			else spinnerValue = spinnerPrevValue;
